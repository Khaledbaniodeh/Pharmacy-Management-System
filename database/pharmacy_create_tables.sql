DROP DATABASE IF EXISTS pharmacy_system_db;
CREATE DATABASE pharmacy_system_db
...
CREATE TABLE branches (
    ...
    CONSTRAINT uq_branch_name_location UNIQUE (branch_name, location)
) ENGINE=InnoDB;
...
CREATE TABLE pharmacists (
    ...
    CONSTRAINT fk_pharmacist_branch
...
CREATE TABLE warehouses (
    ...
    CONSTRAINT uq_warehouse_branch_name UNIQUE (branch_id, warehouse_name),
...
CREATE TABLE medicines (
    ...
    CONSTRAINT chk_medicine_price CHECK (selling_price >= 0),
...
-- =========================
-- 8) Inventory
-- M-M between warehouses and medicines
-- =========================
...
-- =========================
-- 9) Sales
-- Payment method is an attribute, not a separate table
-- =========================
CREATE TABLE sales (
    ...
    branch_id INT NOT NULL,
    payment_method ENUM('CASH', 'CARD', 'INSURANCE', 'MOBILE_PAYMENT', 'OTHER') NOT NULL DEFAULT 'CASH',
...
-- =========================
-- 10) Sale Items
-- M-M between sales and medicines
-- =========================
...
CREATE TABLE purchases (
    ...
    CONSTRAINT fk_purchase_pharmacist
        FOREIGN KEY (pharmacist_id)
        REFERENCES pharmacists(pharmacist_id)
        ON UPDATE CASCADE
        ON DELETE RESTRICT,
...
-- =========================
-- 12) Purchase Items
-- M-M between purchases and medicines
-- =========================
CREATE TABLE purchase_items (
    ...
    CONSTRAINT chk_purchase_item_cost CHECK (cost_price >= 0),
...
-- =========================
-- 13) Invoices
-- One invoice belongs either to one sale OR one purchase
-- No specialization table
-- =========================
CREATE TABLE invoices (
    invoice_id INT AUTO_INCREMENT PRIMARY KEY,
    invoice_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    invoice_type ENUM('SALE', 'PURCHASE') NOT NULL,
    invoice_status ENUM('PAID', 'UNPAID', 'PARTIAL', 'CANCELLED') NOT NULL DEFAULT 'PAID',
    total_amount DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    ...
    CONSTRAINT uq_invoice_sale UNIQUE (sale_id),
    CONSTRAINT uq_invoice_purchase UNIQUE (purchase_id),
    ...
    CONSTRAINT fk_invoice_purchase
        FOREIGN KEY (purchase_id)
        REFERENCES purchases(purchase_id)
        ON UPDATE CASCADE
        ON DELETE RESTRICT
...
-- =========================
-- Useful Indexes for search and reports
-- =========================
